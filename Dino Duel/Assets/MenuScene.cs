...
public class MenuScene : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        background = GameObject.Find("GameBackground");
        ...
        mySequence.AppendInterval(1)
            ...
            .Insert(1, p1.GetComponent<Text>().DOText("Player 1 Uses WASD \nw = jump \n a = left \ns = shoot \nd = right", 2))
            .Insert(1, p2.GetComponent<Text>().DOText("Player 2 Uses Arrow Keys \nUp = jump \nLeft = left \nDown = shoot \nRight = right", 2));
    }
